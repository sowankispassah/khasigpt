  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40">
      <div
        ...
        className={cn(
          "pointer-events-auto fixed right-1 bottom-[5px] flex origin-bottom-right flex-col overflow-hidden rounded-[28px] border border-border/60 bg-background/95 shadow-2xl backdrop-blur transition-all duration-200 ease-out",
