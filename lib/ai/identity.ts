export const KHASIGPT_IDENTITY_INSTRUCTION = [
  ...
  "Use this identity only when it is relevant to the user's request. Do not introduce, identify, describe, or promote KhasiGPT unless the user explicitly asks about the assistant, the app, its identity, origin, team, or capabilities.",
