...
export function normalizeAppSettingValueForWrite<T>(key: string, value: T): T {
  ...
  if (
    normalizedKey === LIVE_TRANSLATION_SUPPORTED_LANGUAGES_SETTING_KEY ||
    normalizedKey === LIVE_TRANSLATION_DEFAULT_LANGUAGE_A_SETTING_KEY ||
    normalizedKey === LIVE_TRANSLATION_DEFAULT_LANGUAGE_B_SETTING_KEY ||
    normalizedKey === LIVE_TRANSLATION_SYSTEM_INSTRUCTION_SETTING_KEY
  ) {
