...
export const STATIC_TRANSLATION_DEFINITIONS: TranslationDefinition[] = [
  ...
  { key: "admin.pricing.make_margin_baseline", defaultText: "Use as margin baseline", description: "Margin-baseline model action." },
  ...
  { key: "admin.pricing.margin_baseline", defaultText: "Margin baseline", description: "Margin baseline status badge." },
  ...
  { key: "admin.pricing.model_form.margin_baseline", defaultText: "Use as margin baseline", description: "New chat model margin baseline checkbox label." },
  { key: "admin.pricing.model_form.image_legacy_price", defaultText: "Legacy fixed price (₹ / image)", description: "Legacy image price field label." },
  { key: "admin.pricing.model_form.image_legacy_credits", defaultText: "Legacy credits per image", description: "Legacy image credit field label." },
  ...
  { key: "admin.pricing.notice.model_margin_baseline", defaultText: "Margin baseline model updated.", description: "Success notice after changing the margin baseline model." },
