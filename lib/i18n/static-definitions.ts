...
export const STATIC_TRANSLATION_DEFINITIONS: TranslationDefinition[] = [
  ...
  { key: "admin.pricing.image_input_cost", defaultText: "Input cost per 1M tokens", description: "Token-priced image provider input cost field." },
  { key: "admin.pricing.image_output_cost", defaultText: "Output cost per 1M tokens", description: "Token-priced image provider output cost field." },
  ...
  { key: "admin.pricing.preview.image_input_tokens", defaultText: "Image input pricing per 1M tokens", description: "Token-priced image input preview heading." },
  { key: "admin.pricing.preview.image_output_tokens", defaultText: "Image output pricing per 1M tokens", description: "Token-priced image output preview heading." },
