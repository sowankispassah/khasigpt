...
export const STATIC_TRANSLATION_DEFINITIONS: TranslationDefinition[] = [
  ...
  { key: "admin.web_search.serper_billing_units_note", defaultText: "The table previews one provider billing unit. Serper standard searches use 1 unit; Shopping searches use 2 units for one API call, so their displayed cost and credit charge are doubled.", description: "Admin pricing note explaining Serper's provider credit units for standard and Shopping searches." },
