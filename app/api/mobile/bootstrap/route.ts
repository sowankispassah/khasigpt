  ...
  const response = NextResponse.json(
    {
      ...
      featureAccess: {
        ...
        exploreMeghalaya: featureSnapshot.exploreMeghalaya,
        forum: featureSnapshot.forum,
        jobs: featureSnapshot.jobs,
        news: featureSnapshot.news,
        liveTranslation: featureSnapshot.liveTranslation,
        liveTranslationAndroid: featureSnapshot.liveTranslationAndroid,
        liveTranslationWeb: featureSnapshot.liveTranslationWeb,
