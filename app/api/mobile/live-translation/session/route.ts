...
export async function POST(request: Request) {
  ...
  const accessMode = await getLiveTranslationAccessModeForPlatform(
    "android"
  ).catch((error) => {
    console.error(
      "[api/mobile/live-translation/session] Feature setting read failed.",
      error
    );
  ...
  const liveVoiceModel = await withTimeout(
    ...
    console.error(
      "[api/mobile/live-translation/session] Voice model read failed.",
      error
    );
    return undefined;
  });
  ...
  const languagesValue = await withTimeout(
    ...
    console.error(
      "[api/mobile/live-translation/session] Supported languages read failed.",
      error
    );
  ...
  const existingChat = await withTimeout(
    ...
    console.error(
      "[api/mobile/live-translation/session] Chat read failed.",
      error
    );
    return undefined;
  });
  ...
  try {
    ...
    console.error(
      "[api/mobile/live-translation/session] Message write failed.",
      error
    );
    return liveTranslationPersistenceUnavailable();
  }
  ...
  try {
    ...
    console.error(
      "[api/mobile/live-translation/session] Token usage write failed.",
      error
    );
    return liveTranslationPersistenceUnavailable();
  }
