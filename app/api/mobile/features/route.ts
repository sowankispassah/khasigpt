  ...
  return NextResponse.json(
    {
      featureAccess: {
        ...
        exploreMeghalaya: snapshot.exploreMeghalaya,
        forum: snapshot.forum,
        jobs: snapshot.jobs,
        news: snapshot.news,
        liveTranslation: snapshot.liveTranslation,
        liveTranslationAndroid: snapshot.liveTranslationAndroid,
        liveTranslationWeb: snapshot.liveTranslationWeb,
